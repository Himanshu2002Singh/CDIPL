    ...
    return (
        ...
        <main className="jewar-main-container flex flex-col md:flex-row">
            <article className="jewar-blog-content p-4 md:w-2/3">
                ...
                <p className="jewar-paragraph">
                    On the first day of operation, the<strong> Noida International Airport</strong> is expected to witness the launch of services by <strong>30 airlines</strong> , which will include both <strong>domestic and international flights </strong> . Of these,<strong> 25 domestic flights, 3 international flights, and 2 cargo flights </strong> are expected to take off, marking the airport’s entry into the global aviation scene. This broad spectrum of flights reflects the airport's ability to cater to a diverse range of passengers, from business travelers to tourists, while also supporting the logistics and cargo sector.
                </p>

                <h3 className="jewar-heading text-xl font-semibold mt-4">Impact on Noida and NCR’s Connectivity</h3>
                <p className="jewar-paragraph">
                    The operationalization of<strong> Jewar International Airport </strong> will significantly enhance the connectivity of Noida with both<strong> domestic and international </strong>  destinations. With Noida being a rapidly growing economic hub, this airport is expected to bring in tremendous growth opportunities, especially in sectors like tourism, real estate, and business. The increase in direct flights to global destinations will make Noida even more attractive to international investors and tourists.
                </p>
                <p className="jewar-paragraph">
                    Moreover, the airport's strategic location will make it easily accessible to residents of Greater Noida, Agra, and other parts of Uttar Pradesh. The anticipated increase in air traffic is also expected to stimulate <strong>job creation and economic development</strong> , benefiting the region’s economy in the long run.
                </p>
